...
function user_setup()
	...
	gear.tp_jse_back = {name="Camulus's Mantle",augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+3','"Store TP"+10',}}
...
function init_gear_sets()
    ...
    sets.precast.WS = {
        ...
        body="Meg. Cuirie +1",hands="Meg. Gloves +2",ring1="Regal Ring",ring2="Karieyh Ring",
    ...
    sets.precast.WS['Leaden Salute'] = {ammo=gear.MAbullet,
        ...
        body="Samnuha Coat",hands="Carmine Fin. Ga. +1",ring1="Regal Ring",ring2="Archon Ring",
        back=gear.magic_wsd_jse_back,waist="Eschan Stone",legs=gear.herculean_wsd_legs,feet=gear.hercluean_nuke_feet}
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
        ...
        body="Samnuha Coat",hands="Carmine Fin. Ga. +1",ring1="Regal Ring",ring2="Ilabrat Ring",
        back=gear.magic_wsd_jse_back,waist="Eschan Stone",legs=gear.herculean_wsd_legs,feet=gear.hercluean_nuke_feet}
    ...
    sets.precast.WS['Wildfire'].Acc = {ammo=gear.MAbullet,
        ...
        body="Samnuha Coat",hands="Leyline Gloves",ring1="Regal Ring",ring2="Ilabrat Ring",
        back=gear.magic_wsd_jse_back,waist="Eschan Stone",legs=gear.herculean_wsd_legs,feet=gear.hercluean_nuke_feet}
    ...
    sets.midcast.RA = {ammo=gear.RAbullet,
        ...
        body="Meg. Cuirie +1",hands="Carmine Fin. Ga. +1",ring1="Ilabrat Ring",ring2="Apate Ring",
        back=gear.ranger_wsd_jse_back,waist="Yemaya Belt",legs="Meg. Chausses +1",feet="Meg. Jam. +1"}

    sets.midcast.RA.Acc = {ammo=gear.RAbullet,
        head="Meghanada Visor +1",neck="Combatant's Torque",ear1="Enervating Earring",ear2="Telos Earring",
        body="Meg. Cuirie +1",hands="Meg. Gloves +2",ring1="Ilabrat Ring",ring2="Apate Ring",
        back=gear.ranger_wsd_jse_back,waist="Yemaya Belt",legs="Meg. Chausses +1",feet="Meg. Jam. +1"}
