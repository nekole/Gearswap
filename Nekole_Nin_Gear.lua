...
function init_gear_sets()
    ...
    sets.precast.WS.Acc = set_combine(sets.precast.WS, {head="Ynglinga Sallet",neck="Combatant's Torque",ear2="Telos Earring",body="Mummu Jacket +1",hands="Mummu Wrists +1",waist="Olseni Belt",legs="Hiza. Hizayoroi +2",feet=gear.herculean_acc_feet})
	sets.precast.WS.FullAcc = set_combine(sets.precast.WS, {head="Ynglinga Sallet",neck="Moonbeam Nodowa",ear1="Zennaroi Earring",ear2="Telos Earring",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",waist="Olseni Belt",legs="Hiza. Hizayoroi +2",feet=gear.herculean_acc_feet})
	
    -- Specific weaponskill sets.  Uses the base set if an appropriate WSMod version isn't found.
    sets.precast.WS['Blade: Jin'] = set_combine(sets.precast.WS, {head="Adhemar Bonnet",ammo="Qirmiz Tathlum",head="Adhemar Bonnet",body="Abnoba Kaftan",hands="Ryuo Tekko",ring1="Begrudging Ring",waist="Grunfeld Rope",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
    sets.precast.WS['Blade: Jin'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Mummu Bonnet +1",ammo="Qirmiz Tathlum",head="Mummu Bonnet +1",body="Abnoba Kaftan",hands="Ryuo Tekko",waist="Grunfeld Rope",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
	...
	sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS, {ammo="Qirmiz Tathlum",head="Adhemar Bonnet",ear1="Moonshade Earring",ear2="Brutal Earring",body="Abnoba Kaftan",hands="Ryuo Tekko",ring1="Begrudging Ring",legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +1"})
    sets.precast.WS['Blade: Hi'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Qirmiz Tathlum",head="Mummu Bonnet +1",ear1="Moonshade Earring",ear2="Trux Earring",body="Mummu Jacket +1",hands="Ryuo Tekko",ring1="Begrudging Ring",legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +1"})
    sets.precast.WS['Blade: Hi'].Acc = set_combine(sets.precast.WS.Acc, {head="Mummu Bonnet +1",ear1="Moonshade Earring",ear2="Telos Earring",body="Mummu Jacket +1",hands="Ryuo Tekko",legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +1"})
    ...
    sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS, {neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",waist="Grunfeld Rope",legs="Hiza. Hizayoroi +2",feet=gear.herculean_wsd_feet})
    sets.precast.WS['Blade: Ten'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {neck="Caro Necklace",ear1="Moonshade Earring",waist="Grunfeld Rope",legs="Hiza. Hizayoroi +2",feet=gear.herculean_wsd_feet})
    ...
    sets.midcast.RA = {
        ...
        body="Mekosu. Harness",hands="Manibozho Gloves",ring1="Ilabrat Ring",ring2="Regal Ring",
    ...
    sets.engaged.Acc = {ammo="Togakushi Shuriken",
        ...
        body="Mummu Jacket +1",hands="Adhemar Wristbands",ring1="Ilabrat Ring",ring2="Regal Ring",
        back="Andartia's Mantle",waist="Olseni Belt",legs="Adhemar Kecks",feet=gear.herculean_acc_feet}
	...
	sets.engaged.FullAcc.PDT = {ammo="Togakushi Shuriken",
        ...
        body="Emet Harness +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Epona's Ring",
        back="Andartia's Mantle",waist="Olseni Belt",legs=gear.herculean_dt_legs,feet="Ahosi Leggings"}
