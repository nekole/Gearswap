...
--				back="Moonbeam Cape",waist="Flume Belt",legs=gear.herculean_dt_legs,feet="Malignance Boots"
}
...
--		body="Hashishin Mintan +1",hands="Leyline Gloves",ring1="Vengeful Ring",ring2="Purity Ring",
 --       back=gear.mab_jse_back,waist="Luminary Sash",legs="Telchine Braconi",feet="Ahosi Leggings"
	...
	sets.DWMax = {ear1="Dudgeon Earring",ear2="Heartseeker Earring",body=gear.AdhemarJacket.B,waist="Reiki Yotai",legs=gear.carmine.legs.D}
...
--		back=gear.stp_jse_back,
	...
	sets.engaged.Acc = {ammo="Falcon Eye",
				...
				back=gear.da_jse_back,waist="Reiki Yotai",legs="Adhemar Kecks",feet="Malignance Boots"}
...
--		hands=gear.HerculeanGloves.TA,
	...
	sets.engaged.DT = {ammo="Ginsen",
			    ...
			    back=gear.da_jse_back,waist="Reiki Yotai",legs="Aya. Cosciales +1",feet="Malignance Boots"}
