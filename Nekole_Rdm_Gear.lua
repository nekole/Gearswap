function user_setup()
	...
	state.Weapons:options('None','Naegling','Sequence','Almace','DualWeapons','DualWeaponsAcc','DualEvisceration','DualClubs','DualAeolian','DualProcDaggers','EnspellOnly')
...
function init_gear_sets()
	...
	sets.precast.JA['Chainspell'] = {body=gear.jse.relic.rdm.body}
	...
	sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",range=empty,ammo="Impatiens",
		head=gear.jse.artifact.rdm.head,neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body=gear.jse.relic.rdm.body,hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Lebeche Ring",
		back="Perimede Cape",waist="Witful Belt",legs=gear.psycloth.legs.D,feet=gear.carmine.feet.D}
	...
	sets.precast.WS = {range=empty,ammo="Voluspa Tathlum",
		head=gear.jse.relic.rdm.head,neck="Asperity Necklace",ear1="Cessance Earring",ear2="Sherida Earring",
		body="Ayanmo Corazza +2",hands="Aya. Manopolas +2",ring1="Petrov Ring",ring2="Ilabrat Ring",
		back=gear.jsecapes.amb.rdm.ws,waist="Windbuffet Belt +1",legs=gear.carmine.legs.D,feet=gear.carmine.feet.D}
	...
	sets.precast.WS.Proc = 	{range=empty,ammo="Hasty Pinion +1",
		...
		back=gear.jsecapes.amb.rdm.ws,waist="Olseni Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.precast.WS['Requiescat'] = {range=empty,ammo="Regal Gem",
		...
		body="Jhakri Robe +2",hands=gear.jse.artifact.rdm.hands,ring1="Ifrit Ring +1",ring2="Rufescent Ring",
		back=gear.jsecapes.amb.rdm.ws,waist="Fotia Belt",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"}
	...
	sets.precast.WS['Chant Du Cygne'] = {range=empty,ammo="Voluspa Tathlum",
		...
		body="Ayanmo Corazza +2",hands=gear.jse.artifact.rdm.hands,ring1="Begrudging Ring",ring2="Ilabrat Ring",
		back=gear.jsecapes.amb.rdm.ws,waist="Fotia Belt",legs=gear.carmine.legs.D,feet="Thereoid Greaves"}
		
	sets.precast.WS['Evisceration'] = sets.precast.WS['Chant Du Cygne']

	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Regal Gem",
		head=gear.jse.relic.rdm.head,neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",
		body=gear.jse.relic.rdm.body,hands=gear.jse.artifact.rdm.hands,ring1="Ifrit Ring +1",ring2="Rufescent Ring",
		back=gear.jsecapes.amb.rdm.ws,waist="Sailfi Belt +1",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"}
	...
	sets.precast.WS['Sanguine Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		...
		body=gear.MerlinicJubbah.MAB,hands="Jhakri Cuffs +2",ring1="Metamor. Ring +1",ring2="Archon Ring",
		back=gear.jsecapes.amb.rdm.nuke,waist="Refoccilation Stone",legs=gear.MerlinicShalwar.MB,feet=gear.MerlinicCrackows.MACC}
		
	sets.precast.WS['Seraph Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		head=gear.MerlinicHood.MAB,neck="Baetyl Pendant",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.MerlinicJubbah.MAB,hands="Jhakri Cuffs +2",ring1="Shiva Ring +1",ring2="Freke Ring",
		back=gear.jsecapes.amb.rdm.nuke,waist="Refoccilation Stone",legs=gear.MerlinicShalwar.MB,feet=gear.MerlinicCrackows.MACC}
		
	sets.precast.WS['Aeolian Edge'] = {range=empty,ammo="Pemphredo Tathlum",
		head=gear.MerlinicHood.MAB,neck="Baetyl Pendant",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.MerlinicJubbah.MAB,hands="Jhakri Cuffs +2",ring1="Metamor. Ring +1",ring2="Freke Ring",
		back=gear.jsecapes.amb.rdm.nuke,waist="Refoccilation Stone",legs=gear.MerlinicShalwar.MB,feet=gear.MerlinicCrackows.MACC}
    ...
    sets.MagicBurst = {main=gear.weapons.BLM.magicstaff,sub="Alber Strap",head="Ea Hat",neck="Mizu. Kubikazari",body="Ea Houppelande",hands=gear.AmalricGages.D,ring1="Mujin Band",legs="Ea Slops",feet="Jhakri Pigaches +2"}
	...
	sets.midcast.FastRecast = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",range=empty,ammo="Hasty Pinion +1",
		...
		back="Swith Cape +1",waist="Witful Belt",legs=gear.psycloth.legs.D,feet="Medium's Sabots"}
    ...
    sets.midcast.Cure = {main="Daybreak",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        ...
        body=gear.jse.relic.rdm.body,hands="Kaykaus Cuffs",ring1="Janniston Ring +1",ring2="Menelaus's Ring",
        back="Tempered Cape +1",waist="Luminary Sash",legs=gear.carmine.legs.D,feet="Kaykaus Boots"}
		
    sets.midcast.LightWeatherCure = {main="Chatoyant Staff",sub="Curatio Grip",range=empty,ammo="Hasty Pinion +1",
        head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Meili Earring",ear2="Mendi. Earring",
        body="Kaykaus Bliaut",hands="Kaykaus Cuffs",ring1="Janniston Ring +1",ring2="Menelaus's Ring",
        back="Twilight Cape",waist="Hachirin-no-Obi",legs=gear.carmine.legs.D,feet="Kaykaus Boots"}
	...
	sets.midcast.Cursna =  set_combine(sets.midcast.Cure, {neck="Debilis Medallion",hands="Hieros Mittens",
		back="Oretan. Cape +1",ring1="Haoma's Ring",ring2="Menelaus's Ring",waist="Witful Belt",feet=gear.vanya.feet.B})
	...
	sets.midcast['Enhancing Magic'] = {main="Arendsi Fleuret",sub="Ammurapi Shield",range=empty,ammo="Hasty Pinion +1",
		head=gear.TelchineCap.ES,neck="Dls. Torque +1",ear1="Andoaa Earring",ear2="Gifted Earring",
		body=gear.jse.relic.rdm.body,hands=gear.jse.artifact.rdm.hands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Embla Sash",legs=gear.TelchineBraconi.ES,feet=gear.jse.empyrean.rdm.feet}

	--Atrophy Gloves are better than Lethargy for me despite the set bonus for duration on others.		
	sets.buff.ComposureOther = {head=gear.jse.empyrean.rdm.head,
		body=gear.jse.empyrean.rdm.body,hands=gear.jse.empyrean.rdm.hands,
		legs=gear.jse.empyrean.rdm.legs,feet=gear.jse.empyrean.rdm.feet}
		
	--Red Mage enhancing sets are handled in a different way from most, layered on due to the way Composure works
	--Don't set combine a full set with these spells, they should layer on Enhancing Set > Composure (If Applicable) > Spell
	sets.EnhancingSkill = {main="Pukulatmuj +1",head="Befouled Crown",neck="Incanter's Torque",ear2="Mimir Earring",hands=gear.jse.relic.rdm.hands,back="Ghostfyre Cape",waist="Olympus Sash",legs=gear.jse.artifact.rdm.legs}
	sets.midcast.Refresh = {head=gear.AmalricCoif.DPlus,body=gear.jse.artifact.rdm.body,legs=gear.jse.empyrean.rdm.legs}
	sets.midcast.Aquaveil = {head=gear.AmalricCoif.DPlus,hands="Regal Cuffs",waist="Emphatikos Rope",legs="Shedir Seraweels"}
	...
	sets.midcast.BoostStat = {hands=gear.jse.relic.rdm.hands}
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak",sub="Ammurapi Shield",range=empty,ammo="Regal Gem",
		head=gear.jse.relic.rdm.head,neck="Dls. Torque +1",ear1="Regal Earring",ear2="Snotra Earring",
		body=gear.jse.empyrean.rdm.body,hands="Kaykaus Cuffs",ring1="Kishar Ring",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Luminary Sash",legs=gear.ChironicHose.MAB,feet=gear.jse.relic.rdm.feet}
		
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head=gear.jse.relic.rdm.head,neck="Dls. Torque +1",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.jse.artifact.rdm.body,hands="Kaykaus Cuffs",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Luminary Sash",legs=gear.ChironicHose.MAB,feet=gear.jse.relic.rdm.feet}
	...
	sets.midcast.SkillBasedEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {ear1="Vor Earring",hands=gear.jse.empyrean.rdm.hands,ring1="Stikini Ring +1",legs=gear.psycloth.legs.B})
	...
	sets.midcast['Bio III'] = set_combine(sets.midcast['Enfeebling Magic'], {head=gear.jse.relic.rdm.head,waist="Chaac Belt"})
    ...
    sets.midcast['Elemental Magic'] = {main="Daybreak",sub="Ammurapi Shield",range=empty,ammo="Dosis Tathlum",
        ...
        body=gear.MerlinicJubbah.MAB,hands=gear.AmalricGages.D,ring1="Shiva Ring +1",ring2="Freke Ring",
        back=gear.jsecapes.amb.rdm.nuke,waist=gear.ElementalObi,legs=gear.MerlinicShalwar.MB,feet=gear.MerlinicCrackows.MACC}
		
    sets.midcast['Elemental Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head=gear.MerlinicHood.MAB,neck="Dls. Torque +1",ear1="Regal Earring",ear2="Friomisi Earring",
        body=gear.MerlinicJubbah.MAB,hands=gear.AmalricGages.D,ring1="Metamor. Ring +1",ring2="Freke Ring",
        back=gear.jsecapes.amb.rdm.nuke,waist="Refoccilation Stone",legs=gear.MerlinicShalwar.MB,feet=gear.MerlinicCrackows.MACC}
    ...
    sets.midcast['Elemental Magic'].Proc = {main=empty,sub=empty,range=empty,ammo="Impatiens",
        ...
        body="Zendik Robe",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Prolix Ring",
        back="Swith Cape +1",waist="Witful Belt",legs=gear.psycloth.legs.D,feet="Regal Pumps +1"}
	...
	sets.midcast.Impact = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		body=gear.jse.artifact.rdm.body,hands=gear.jse.empyrean.rdm.hands,ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Luminary Sash",legs=gear.MerlinicShalwar.MB,feet=gear.MerlinicCrackows.MACC}
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		body=gear.jse.artifact.rdm.body,hands=gear.jse.empyrean.rdm.hands,ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Luminary Sash",legs=gear.psycloth.legs.D,feet=gear.MerlinicCrackows.MACC}

    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
        head="Pixie Hairpin +1",neck="Erra Pendant",ear1="Regal Earring",ear2="Malignance Earring",
        body=gear.MerlinicJubbah.MAB,hands="Kaykaus Cuffs",ring1="Evanescence Ring",ring2="Archon Ring",
        back=gear.jsecapes.amb.rdm.nuke,waist="Fucho-no-obi",legs="Chironic Hose",feet=gear.chironic_nuke_feet}

	sets.midcast.Aspir = sets.midcast.Drain
		
	sets.midcast.Stun = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",range=empty,ammo="Hasty Pinion +1",
		head=gear.jse.artifact.rdm.head,neck="Orunmila's Torque",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.jse.artifact.rdm.body,hands="Gende. Gages +1",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Sailfi Belt +1",legs=gear.psycloth.legs.D,feet=gear.MerlinicCrackows.MACC}
		
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head=gear.AmalricCoif.C,neck="Dls. Torque +1",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.jse.artifact.rdm.body,hands="Gende. Gages +1",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back=gear.jsecapes.amb.rdm.nuke,waist="Acuity Belt +1",legs=gear.psycloth.legs.D,feet=gear.MerlinicCrackows.MACC}

	-- Sets for special buff conditions on spells.
		
	sets.buff.Saboteur = {hands=gear.jse.empyrean.rdm.hands}
	...
	sets.HPCure = {main="Daybreak",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        ...
        body=gear.jse.relic.rdm.body,hands="Kaykaus Cuffs",ring1="Gelatinous Ring +1",ring2="Meridian Ring",
	...
	sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",range=empty,ammo="Impatiens",
		head=gear.jse.relic.rdm.head,neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Jhakri Robe +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Sheltered Ring",
		back="Umbra Cape",waist="Flume Belt +1",legs="Lengo Pants",feet="Malignance Boots"}
	...
	sets.idle.MDT = {main="Daybreak",sub="Genmei Shield",range=empty,ammo="Staunch Tathlum",
	...
	sets.idle.DTHippo = set_combine(sets.idle.PDT, {back="Umbra Cape",legs=gear.carmine.legs.D,feet="Hippo. Socks +1"})
	...
	sets.defense.MDT = {main="Bolelabunga",sub="Genmei Shield",range=empty,ammo="Staunch Tathlum",
		head="Malignance Chapeau",neck="Warder's Charm +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Gelatinous Ring +1",
		back="Moonbeam Cape",waist="Carrier's Sash",legs="Malignance Tights",feet="Malignance Boots"}
		
    sets.defense.MEVA = {main="Daybreak",sub="Genmei Shield",range=empty,ammo="Staunch Tathlum",
		head="Malignance Chapeau",neck="Warder's Charm +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Gelatinous Ring +1",
		back="Moonbeam Cape",waist="Carrier's Sash",legs="Malignance Tights",feet="Malignance Boots"}
...
--		body="Ayanmo Corazza +2",hands="Aya. Manopolas +2",ring1="Petrov Ring",ring2="Ilabrat Ring",
--		back=gear.jsecapes.amb.rdm.tp,waist="Windbuffet Belt +1",legs=gear.carmine.legs.D,feet=gear.carmine.feet.D}
	...
	sets.engaged = {ammo="Aurgelmir Orb +1",
		...
		back=gear.jsecapes.amb.rdm.tp,waist="Windbuffet Belt +1",legs="Malignance Tights",feet=gear.carmine.feet.D}
	...
	sets.engaged.DT = {ammo="Aurgelmir Orb +1",
		...
		back="Moonbeam Cape",waist="Windbuffet Belt +1",legs="Hagondes Pants +1",feet="Battlecast Gaiters"}
		
	sets.engaged.Acc.DT = {ammo="Aurgelmir Orb +1",
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Hagondes Cuffs +1",ring1="Defending Ring",ring2="Dark Ring",
		back="Moonbeam Cape",waist="Flume Belt +1",legs="Hagondes Pants +1",feet="Battlecast Gaiters"}
	...
	sets.engaged.DW = {ammo="Aurgelmir Orb +1",
		...
		back=gear.jsecapes.amb.rdm.tp,waist="Windbuffet Belt +1",legs=gear.carmine.legs.D,feet="Malignance Boots"}
	...
	sets.engaged.DW.Acc = {ammo="Aurgelmir Orb +1",
		...
		back=gear.jsecapes.amb.rdm.tp,waist="Olseni Belt",legs=gear.carmine.legs.D,feet="Malignance Boots"}
