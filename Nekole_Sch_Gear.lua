...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Oranyan",sub="Clerisy Strap +1",ammo="Impatiens",
        head=gear.AmalricCoif.DPlus,neck="Orunmila's Torque",ear1=gear.ears.fc_left,
        ear2=gear.ears.fc_right,body="Zendik Robe",hands="Gende. Gages +1",		ring1=gear.ring.fc_left,
		ring2=gear.ring.fc_right,back="Perimede Cape",waist="Witful Belt",legs=gear.psycloth.legs.D,feet="Regal Pumps +1"}
    ...
    sets.midcast.Cure = {main="Serenity",sub="Curatio Grip",ammo="Hasty Pinion +1",
        head=gear.gendewitha.head.pdt,neck="Incanter's Torque",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
	...
	sets.midcast['Elemental Magic'].HighTierNuke.Resistant = set_combine(sets.midcast['Elemental Magic'].Resistant, {main=gear.grioavolr_nuke_staff,sub="Niobid Strap",ammo="Pemphredo Tathlum",ear1="Regal Earring",ear2="Barkaro. Earring",hands="Amalric Gages"})
	sets.midcast['Elemental Magic'].HighTierNuke.Fodder = set_combine(sets.midcast['Elemental Magic'].Fodder, {sub="Alber Strap",ammo="Pemphredo Tathlum",ear1="Regal Earring",ear2="Barkaro. Earring",hands="Amalric Gages"})
    ...
    sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",ammo="Homiliary",
		...
		body=gear.AmalricDoublet.A,hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
    ...
    sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        ...
        body=gear.ambuscade.jhakri.body,hands=gear.AmalricGages.A,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
        body=gear.ambuscade.jhakri.body,hands=gear.AmalricGages.A,ring1="Defending Ring",ring2="Dark Ring",
        back="Umbra Cape",waist="Flax Sash",legs="Assid. Pants +1",feet="Psycloth Boots"}
